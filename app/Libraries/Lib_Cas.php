...
class Lib_Cas extends phpCAS
{
    ...
    public function __construct()
    {
        ...
        $client_service_name = 'http://localhost.ums.ac.id:8088/';
        ...
        // phpCAS::client() skips session_start() when session_id() !== "".
        // CI4's session must therefore be started BEFORE this call (done in
        // AuthController::loginWithCas), so phpCAS reuses CI4's session instead
        // of creating its own — preventing the ini_set conflict.
